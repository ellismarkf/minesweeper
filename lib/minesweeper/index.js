...
export const getThreatCount2 = (pos, tiles, cols, perimeter) => {
  let threatCount = 0;
...
export const markThreatCounts2 = (tiles, cols) =>
  tiles.map((tileValue, pos, tiles) => {
    const perimeter = getPerimeter(pos, cols);
    return getThreatCount2(pos, tiles, cols, perimeter);
  });
...
export const board = (rows = 9, cols = 9, mines = 10) => {
  ...
  return {
    ...
    tiles: t,
    threats: markThreatCounts2(t, cols),
    mode: 0,
    game: 0
  }
}